...
const String device_serial_key = "SENO8vfDWJmhlEFD0SaB";
...
int networkState = 1;
int networkAddrH = 0x37;
int networkAddrL = 0x44;
...
{  
  ...
  if((timeCheckReset) >= (1*(24*60*60/8))) //change to reset 1day
  {    
    timeCheckReset = 0;
    blinkDebugLed(5, 50);
    rebootDevice();
